...
type Props = {
    form: InertiaForm<BrandFormData>;
    brand?: AdminBrand;
};
...
function setImageSource(source: BrandFormData['image_source']): void {
...
<template>
    <div class="grid gap-6">
        <div class="grid gap-2">
            ...
            <Input id="name" v-model="form.name" required placeholder="Brand name" />
            <InputError :message="form.errors.name" />
        </div>

        <div class="grid gap-2">
            <Label for="slug">Slug</Label>
            <Input id="slug" v-model="form.slug" placeholder="brand-slug" />
        ...
        <div class="grid gap-4">
            ...
            <div v-else class="grid gap-2">
                ...
                <p class="text-xs text-muted-foreground">
                    ...
                    <span v-if="brand?.image_source === 'upload'">
            ...
            <div v-if="previewUrl" class="size-32 overflow-hidden rounded-lg border bg-muted">
                <img :src="previewUrl" alt="Brand image preview" class="size-full object-cover" />
            </div>
        </div>
