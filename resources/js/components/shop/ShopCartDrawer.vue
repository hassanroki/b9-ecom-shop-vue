...
<template>
    <div>
        ...
        <aside
            ...
            <div v-if="cart.length === 0" class="flex flex-1 flex-col items-center justify-center px-6 text-center">
                            ...
                            <div class="mt-2 flex items-center justify-between">
                                <div class="inline-flex items-center rounded-lg border border-gray-300">
                                    <button type="button" aria-label="Decrease"
                                        ...
                                        :disabled="item.qty <= 1" @click="updateQty(item.productId, item.qty - 1)">
                                        <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                                            stroke-width="2">
                ...
                <div class="shrink-0 border-t border-gray-200 p-5">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <Link :href="shop.cart()"
                            ...
                            @click="closeCart">View Cart</Link>
