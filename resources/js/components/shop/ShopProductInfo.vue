    ...
    <div>
        ...
        <div class="mt-3 flex flex-wrap items-center gap-3">
            ...
            <span v-if="product.inStock"
                class="rounded-full bg-green-50 px-2.5 py-1 text-xs font-medium text-green-700">In Stock</span>
        </div>
        ...
        <div class="flex flex-wrap items-center gap-4">
            <div>
                <span class="mb-1.5 block text-sm font-medium text-gray-700">Quantity</span>
        ...
        <div class="mt-6 space-y-3 rounded-xl border border-gray-200 bg-gray-50 p-4">
            <div class="flex items-start gap-3">
                <svg class="mt-0.5 h-5 w-5 shrink-0 text-shop-primary-600" fill="none" viewBox="0 0 24 24"
                    stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round"
