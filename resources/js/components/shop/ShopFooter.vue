...
import { index as faq } from '@/routes/faq';
        ...
        <div class="mx-auto max-w-7xl px-4 py-12 sm:px-6 md:py-16 lg:px-8">
            <div class="grid grid-cols-1 gap-10 md:grid-cols-4">
                ...
                <div class="space-y-5">
                    ...
                    <p class="max-w-sm text-xs leading-relaxed font-medium text-[#737373]">
                ...
                <!-- কুইক লিংকস -->
                <div>
                    <h3 class="text-xs font-bold tracking-widest text-gray-700 uppercase">
                        Quick Links
                    </h3>
                    <ul class="mt-4 space-y-2.5 text-xs font-semibold">
                        <li>
                            <Link :href="home()" class="text-[#525252] transition-colors hover:text-[#87E64B]">Home
                            </Link>
                        </li>
                        <li>
                            <Link :href="shop.index()" class="text-[#525252] transition-colors hover:text-[#87E64B]">
                                Shop</Link>
                        </li>
                        <li>
                            <a href="#bestselling" class="text-[#525252] transition-colors hover:text-[#87E64B]">Best
                                Selling</a>
                        </li>
                        <li>
                            <a href="#newcollection" class="text-[#525252] transition-colors hover:text-[#87E64B]">New
                                Collection</a>
                        </li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="mt-4 space-y-2.5 text-xs font-semibold">
                        <li>
                            <a href="#" class="text-[#525252] transition-colors hover:text-[#87E64B]">Track Your
                                Order</a>
                        </li>
                        <li>
                            <a href="#" class="text-[#525252] transition-colors hover:text-[#87E64B]">Shipping &amp;
                                Delivery</a>
                        </li>
                        <li>
                            <a href="#" class="text-[#525252] transition-colors hover:text-[#87E64B]">Returns &amp;
                                Refunds</a>
                        </li>
                        <li>
                            <Link :href="faq()" class="text-[#525252] transition-colors hover:text-[#87E64B]">FAQ</Link>
                        </li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="mt-4 space-y-3 text-xs font-semibold text-[#525252]">
                        <li class="flex items-start gap-2.5">
                            ...
                            <span class="leading-relaxed">House 12, Road 5, Dhanmondi, Dhaka 1205</span>
                        </li>
                        <li class="flex items-center gap-2.5">
                            ...
                            <a href="tel:+8801770910017" class="transition-colors hover:text-[#87E64B]">+880
                                1770910017</a>
                        </li>
                        <li class="flex items-center gap-2.5">
                            <svg class="h-4 w-4 shrink-0 text-gray-400" fill="none" viewBox="0 0 24 24"
                            ...
                            <a href="mailto:hassan0cse@gmail.com"
                                class="transition-colors hover:text-[#87E64B]">hassan0cse@gmail.com</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div
                ...
                <div class="flex items-center gap-2">
                    <span class="mr-1 text-[11px] font-bold tracking-wider text-[#737373] uppercase">We accept</span>
                    <span
