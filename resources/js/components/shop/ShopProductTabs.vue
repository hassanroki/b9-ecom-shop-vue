                        ...
                        <div class="mt-10 rounded-xl border border-gray-200 bg-white p-6">
                            ...
                            <form class="mt-4 space-y-4" @submit="submitReview">
                                ...
                                <button type="submit" :disabled="isSubmitting"
                                    class="rounded-lg bg-shop-primary-600 px-5 py-2.5 text-sm font-semibold text-white transition hover:bg-shop-primary-700 focus:ring-2 focus:ring-shop-primary-600 focus:outline-none disabled:cursor-not-allowed disabled:opacity-60">
