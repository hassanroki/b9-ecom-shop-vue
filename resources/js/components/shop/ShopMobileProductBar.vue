...
<template>
    <div class="fixed inset-x-0 bottom-0 z-40 border-t border-gray-200 bg-white/95 backdrop-blur lg:hidden">
        <div class="flex items-center gap-3 px-4 py-3">
            <div class="leading-tight">
                <p class="text-lg font-bold text-shop-primary-600">
                    {{ formatTaka(product.price) }}
                </p>
                <p v-if="product.oldPrice" class="text-xs text-gray-400 line-through">
