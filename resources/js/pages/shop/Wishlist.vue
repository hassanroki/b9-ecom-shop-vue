    ...
    <div class="py-6 md:py-10">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <template v-else>
                ...
                <div v-if="wishCount > 0" class="grid grid-cols-2 gap-4 sm:grid-cols-3 md:gap-6 lg:grid-cols-4">
                    <ShopWishlistCard v-for="item in wishlist" :key="item.id" :item="item" @remove="handleRemove"
