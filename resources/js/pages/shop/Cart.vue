...
<template>
    ...
    <div class="bg-gray-50 py-6 md:py-10">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div v-if="cart.length > 0" class="grid grid-cols-1 gap-6 lg:grid-cols-3 lg:gap-8">
                <div class="lg:col-span-2">
                    <div class="overflow-hidden rounded-xl border border-gray-200 bg-white">
                        ...
                        <ul class="divide-y divide-gray-100">
                            <ShopCartLineItem v-for="item in cart" :key="item.productId" :item="item"
                    ...
                    <div class="mt-4 flex items-center justify-between">
                        ...
                        <button type="button" class="text-sm font-medium text-gray-500 transition hover:text-red-600"
                ...
                <div class="lg:col-span-1">
                    <ShopCartSummary :item-count="cartQty" :subtotal="cartSubtotal" />
                </div>
            </div>
