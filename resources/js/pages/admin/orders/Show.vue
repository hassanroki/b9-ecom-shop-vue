...
<template>
    ...
    <div id="order-screen" class="flex h-full flex-1 flex-col gap-6 rounded-xl p-4">
        ...
        <Card v-if="order.status !== 'cancelled'"
            class="border-none shadow-sm bg-gradient-to-br from-slate-50 to-white dark:from-slate-900/40 dark:to-background">
