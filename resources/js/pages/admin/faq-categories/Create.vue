...
import type { FaqCategoryFormData } from '@/types/admin';
...
function submit(): void {
    form.post(FaqCategoryController.store.url(), {
        preserveScroll: true,
    });
}
</script>
...
<template>
    ...
    <div class="mx-auto flex w-full max-w-5xl flex-col gap-6 p-4 sm:p-6 lg:p-8">
        ...
        <div class="flex items-center gap-3">
            ...
            <Heading title="Create FAQ category" description="Add a new FAQ category group" />
        </div>
