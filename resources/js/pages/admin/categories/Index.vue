...
<template>
    ...
    <div class="flex h-full flex-1 flex-col gap-5 p-4 md:p-6">
        ...
        >
            <p class="text-sm font-medium text-foreground">No categories yet</p>
            ...
            <div class="flex flex-col gap-3 md:hidden">
                ...
                >
                    <div class="flex items-start gap-3">
                        <div
                            class="size-12 shrink-0 overflow-hidden rounded-lg border border-border bg-muted"
                        >
                            <img
                                v-if="category.image"
                                :src="category.image"
                    ...
                    <table class="w-full min-w-200 text-sm">
                        ...
                        <tbody>
                            ...
                            >
                                ...
                                <td
                                    class="px-5 py-3.5 font-medium text-foreground"
                                >
                                    {{ category.name }}
                                </td>
                                <td
