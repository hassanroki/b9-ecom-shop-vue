...
<template>
    ...
    <div class="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <Heading title="Categories" description="Manage product categories for your store" />
                ...
                <table class="w-full min-w-[960px] text-sm">
                    ...
                    <tbody>
                        <tr v-for="category in categories" :key="category.id" class="border-b last:border-b-0">
                            ...
                            <td class="px-4 py-3">
                                <Badge :variant="category.is_active
                                        ? 'default'
                                        : 'secondary'
                                    ">
                                    {{
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center justify-end gap-2">
                                    ...
                                    <Dialog>
                                        ...
                                        <DialogContent>
                                            <Form v-bind="CategoryController.destroy.form(
                                                category.id,
                                            )
                                                " :options="{
                                                    preserveScroll: true,
