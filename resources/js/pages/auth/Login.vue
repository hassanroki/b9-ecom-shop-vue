...
<template>
    <Head title="Log in">
        <meta name="description" content="Log in to your ShopBD account." />
    </Head>
    ...
    <div class="flex min-h-[75vh] items-center justify-center bg-gray-50 px-4 py-16">
        <div class="w-full max-w-md">
            ...
            <div class="mb-8 flex flex-col items-center gap-2 text-center">
                ...
                <p class="text-sm text-gray-500">Log in to continue to ShopBD</p>
            </div>
            ...
            <div class="rounded-2xl border border-gray-100 bg-white p-8 shadow-sm">
                ...
                <Form v-bind="store.form()" :reset-on-success="['password']" v-slot="{ errors, processing }"
                    ...
                    <div class="flex flex-col gap-1.5">
                        ...
                        <div class="relative">
                            ...
                            <input id="email" type="email" name="email" placeholder="you@example.com" required
                                autofocus :tabindex="1" autocomplete="email"
                    ...
                    <div class="flex flex-col gap-1.5">
                        <div class="flex items-center justify-between">
                            ...
                            <TextLink v-if="canResetPassword" :href="request()"
                                class="text-xs font-medium text-shop-primary-600 hover:text-shop-primary-700"
                                :tabindex="4">
                                Forgot password?
                            </TextLink>
                        </div>
                    ...
                    <button type="submit" :tabindex="3" :disabled="processing" data-test="login-button"
            ...
            <p class="mt-6 text-center text-sm text-gray-500">
                ...
                <TextLink :href="register()" :tabindex="5" class="font-semibold text-shop-primary-600 hover:text-shop-primary-700">
                    Sign up
                </TextLink>
            </p>
        </div>
