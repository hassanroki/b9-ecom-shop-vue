        ...
        <Form v-bind="store.form()" :reset-on-success="['password']" v-slot="{ errors, processing }"
            ...
            <div class="flex flex-col gap-5">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <PasswordInput id="password" name="password" placeholder="Password" required :tabindex="2"
            ...
            <div class="flex items-center justify-center">
                <TextLink v-if="canResetPassword" :href="request()" class="text-sm text-stone-500 hover:text-stone-700"
                    :tabindex="4">
                    Forgot password?
                </TextLink>
            </div>
            ...
            <p class="text-center text-sm text-stone-500">
                ...
                <TextLink :href="register()" :tabindex="5" class="font-medium text-stone-800 hover:text-stone-700">
                    Sign up
                </TextLink>
            </p>
        </Form>
